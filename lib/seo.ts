...
export const siteSEO: Record<string, PageSEO> = {
  ...
  'pdf-to-ppt': {
    ...
    description: 'Convert your PDFs to POWERPOINT.',
    path: '/pdf-to-ppt',
  ...
  'smart-watermark': {
    ...
    description: 'Add text or logo watermarks with opacity, rotation, position, and multi-page support.',
  ...
  protect: {
    ...
    description: 'Protect your PDFs online for privacy, security, and peace of mind—free and fast. Add strong encryption to any PDF directly in your browser. No software downloads, no account required.',
    path: '/protect',
  ...
  'password-check': {
    ...
    description: 'Analyze PDF password strength with cracking time estimates and improvement tips.',
    path: '/password-check',
    keywords: ['pdf password checker', 'pdf security check', 'password strength analyzer', 'pdf password audit', 'check pdf security'],
  },
  organize: {
    title: 'Organize PDF',
    description: 'Need to organize PDF pages for free? Rearrange, replace, add, delete, rotate, and reorder PDF pages with our intuitive drag-and-drop tool. No signup or downloads required.',
    path: '/organize',
    keywords: ['organize pdf', 'reorder pdf pages', 'sort pdf pages', 'pdf page organizer', 'arrange pdf pages', 'manage pdf pages'],
  },
  crop: {
    title: 'Crop PDF',
    description: 'Trim PDF margins in seconds. Easily resize PDF pages with the PDF cropper.',
    path: '/crop',
  ...
  ocr: {
    title: 'PDF OCR',
    description: 'Quickly convert your scanned, non-searchable PDFs into searchable and selectable text documents for free. Improve accessibility and usability without the need for manual transcription.',
    path: '/ocr',
  ...
  'ocr-editable': {
    ...
    description: 'Convert scanned PDFs into searchable, selectable text PDF documents.',
    path: '/ocr-editable',
  ...
  'scan-to-pdf': {
    title: 'Scan to PDF',
    description: 'Scan documents from your smartphone to your browser.',
    path: '/scan-to-pdf',
  ...
  redact: {
    title: 'Redact PDF',
    description: 'Permanently remove sensitive information from your documents with our free PDF redaction tool. No signup or downloads required. No files left on our servers when you\'re done.',
    path: '/redact',
  ...
  esignature: {
    ...
    description: 'Sign PDF documents online in just a few clicks. No account creation or installation required.',
    path: '/esignature',
  ...
  summarizer: {
    ...
    description: 'Summarize PDFs and other file types in seconds with our free AI PDF Summarizer—no registration required. Upload multiple documents at once and even summarize scanned PDFs with ease.',
    path: '/summarizer',
  ...
  workflows: {
    title: 'Workflows',
    description: 'Create chains of tools to automate your PDF tasks.',
    path: '/workflows',
  ...
  community: {
    title: 'Community Q&A',
    description: 'Ask questions, share knowledge, and get help from the DocuPDF community.',
    path: '/community',
